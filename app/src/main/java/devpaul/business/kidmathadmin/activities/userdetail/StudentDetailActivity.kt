package devpaul.business.kidmathadmin.activities.userdetail
...
class StudentDetailActivity : AppCompatActivity() {
    ...
    private fun getUserInformation(){
        ...
        if (type != null && type.equals("suma", ignoreCase = true)) {
            ...
            myref.child("AllResultsSum").orderByChild("userId").equalTo(idUser).addListenerForSingleValueEvent(object  : ValueEventListener{
        ...
        if (type != null && type.equals("resta", ignoreCase = true)) {
            ...
            progressDialog?.setContentView(R.layout.charge_dialog)
            Objects.requireNonNull(progressDialog!!.window)?.setBackgroundDrawableResource(android.R.color.transparent)
            myref.child("AllResultsRes").orderByChild("userId").equalTo(idUser).addListenerForSingleValueEvent(object  : ValueEventListener{
        ...
        if (type != null && type.equals("multiplicacion", ignoreCase = true)) {
            ...
            progressDialog?.setContentView(R.layout.charge_dialog)
            Objects.requireNonNull(progressDialog!!.window)?.setBackgroundDrawableResource(android.R.color.transparent)
            myref.child("AllResultsMul").orderByChild("userId").equalTo(idUser).addListenerForSingleValueEvent(object  : ValueEventListener{
        ...
        if (type != null && type.equals("division", ignoreCase = true)) {
            ...
            progressDialog?.setContentView(R.layout.charge_dialog)
            Objects.requireNonNull(progressDialog!!.window)?.setBackgroundDrawableResource(android.R.color.transparent)
            myref.child("AllResultsDiv").orderByChild("userId").equalTo(idUser).addListenerForSingleValueEvent(object  : ValueEventListener{
                @SuppressLint("SetTextI18n")
                override fun onDataChange(dataSnapshot: DataSnapshot) {
