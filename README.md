...
_Este proyecto es parte del otro proyecto llamado [Math4kids](https://github.com/PaulGuillen/KidMathKotlin), para ir entrando en el tema, la idea es la siguiente app A conectado a firebase store, la app B consulta la información de firebase store, database realtime, storage._
